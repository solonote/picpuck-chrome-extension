 ...
 * @property {boolean} [recoverAllocateSilentDefault] 为 true 时：异步找回「检查」默认静默；`chrome.storage.sync.picpuckRecoverCheckFocusTab===true` 时检查阶段激活工作 Tab。「取回」就绪后由业务步骤显式 `focusWorkTab`。
 */
